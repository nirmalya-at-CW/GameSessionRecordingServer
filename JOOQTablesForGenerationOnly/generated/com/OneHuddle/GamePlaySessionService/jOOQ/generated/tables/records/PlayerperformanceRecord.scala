...
class PlayerperformanceRecord extends UpdatableRecordImpl[PlayerperformanceRecord](Playerperformance.PLAYERPERFORMANCE) with Record11[Integer, String, String, String, String, String, Timestamp, String, Integer, Integer, Integer] {
  ...
  // -------------------------------------------------------------------------
  override def key : Record8[Integer, String, String, String, String, String, Timestamp, String] = {
    return super.key.asInstanceOf[ Record8[Integer, String, String, String, String, String, Timestamp, String] ]
  }
  ...
  override def fieldsRow : Row11[Integer, String, String, String, String, String, Timestamp, String, Integer, Integer, Integer] = {
    super.fieldsRow.asInstanceOf[ Row11[Integer, String, String, String, String, String, Timestamp, String, Integer, Integer, Integer] ]
  }

  override def valuesRow : Row11[Integer, String, String, String, String, String, Timestamp, String, Integer, Integer, Integer] = {
    super.valuesRow.asInstanceOf[ Row11[Integer, String, String, String, String, String, Timestamp, String, Integer, Integer, Integer] ]
  }
  ...
  override def field7 : Field[Timestamp] = Playerperformance.PLAYERPERFORMANCE.LASTPLAYEDON
  override def field8 : Field[String] = Playerperformance.PLAYERPERFORMANCE.TIMEZONEAPPLICABLE
  override def field9 : Field[Integer] = Playerperformance.PLAYERPERFORMANCE.POINTSOBTAINED
  override def field10 : Field[Integer] = Playerperformance.PLAYERPERFORMANCE.TIMETAKEN
  override def field11 : Field[Integer] = Playerperformance.PLAYERPERFORMANCE.WINSACHIEVED
  ...
  override def component7 : Timestamp = getLastplayedon
  override def component8 : String = getTimezoneapplicable
  override def component9 : Integer = getPointsobtained
  override def component10 : Integer = getTimetaken
  override def component11 : Integer = getWinsachieved
  ...
  override def value7 : Timestamp = getLastplayedon
  override def value8 : String = getTimezoneapplicable
  override def value9 : Integer = getPointsobtained
  override def value10 : Integer = getTimetaken
  override def value11 : Integer = getWinsachieved
  ...
  override def value7(value : Timestamp) : PlayerperformanceRecord = {
    setLastplayedon(value)
    this
  }

  override def value8(value : String) : PlayerperformanceRecord = {
    setTimezoneapplicable(value)
    this
  }

  override def value9(value : Integer) : PlayerperformanceRecord = {
  ...
  override def values(value1 : Integer, value2 : String, value3 : String, value4 : String, value5 : String, value6 : String, value7 : Timestamp, value8 : String, value9 : Integer, value10 : Integer, value11 : Integer) : PlayerperformanceRecord = {
    this.value1(value1)
    this.value2(value2)
    this.value3(value3)
    this.value4(value4)
   ...
   */
  def this(recordid : Integer, companyid : String, belongstodepartment : String, playerid : String, gameid : String, gametype : String, lastplayedon : Timestamp, timezoneapplicable : String, pointsobtained : Integer, timetaken : Integer, winsachieved : Integer) = {
    this()
